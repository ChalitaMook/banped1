...
<x-app-layout>
    ...
    <div class="container card rounded mt-3">
        <div class="container-fluid">
            <form action="{{url('user_form_update/'.$item2->id)}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="container">
                    ...
                    <div class="d-flex justify-content-between align-items-lg-center py-3 flex-column flex-lg-row">
                        <h2 class="h5 mb-3 mb-lg-0"><a href="../../pages/admin/customers.html" class="text-muted"><i
                                    class="bi bi-arrow-left-square me-2"></i></a> <b>ฟอร์มแก้ไขข้อมูลพนักงาน</b> </h2>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control pr-5 rounded-pill" type="text"
                                                    name="name" id="name" value="{{$item2->name}}">
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label"> <b>อีเมล</b> </label>
                                                <input class="form-control pr-5 rounded-pill" type="text"
                                                    name="email" id="email" value="{{ $item2->email }}">
                                            </div>
                                            <div class="mb-3">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <br>
                                                <select class="form-select rounded-pill pr-5 form-control" aria-label="role" id="role" name="role">

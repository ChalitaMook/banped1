                ...
                <div class="container">
                    ...
                    <div class="d-flex justify-content-between align-items-lg-center py-3 flex-column flex-lg-row">
                        <h2 class="h5 mb-3 mb-lg-0"><a href="../../pages/admin/customers.html" class="text-muted"><i
                                    class="bi bi-arrow-left-square me-2"></i></a> <b>ฟอร์มแก้ไขข้อมูลประเภทข้อร้องเรียน</b> </h2>
                            ...
                            <div class="card mb-4">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                <label class="form-label"> <b>ชื่อประเภท</b> </label>
                                                <input class="form-control pr-5 rounded-pill" type="text"
                                                    name="name" id="name" value="{{$item2->name}}">
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label"> <b>หน่วยงานที่ดูแล</b> </label>
